    ...
    <div className="container">
      ...
      <div className="card mt-4 bg-light">
        <div className="card-body">
          <h3 className="text-center mb-3">O que é a Célula de Casais?</h3>
          <p className="texto-justificado">
            ...
            que se reúnem regularmente, geralmente em lares, com o propósito de fortalecer a fé, o casamento e a comunhão
            cristã, sempre fundamentados na Palavra de Deus.
            <br /><br />
            Esses encontros acontecem fora do culto tradicional e têm como foco o crescimento espiritual do casal, o
            fortalecimento do relacionamento conjugal, a valorização da família e a vivência dos princípios cristãos.
            A célula promove um ambiente de discipulado, cuidado mútuo, apoio espiritual e comunhão, onde os casais podem
            compartilhar experiências, aprender juntos e caminhar em unidade, edificando lares firmes e alinhados com os
            propósitos de Deus.
          </p>
          ...
          <div className="videos-grid">
            <div className="video-card">
              <iframe
                width="640"
                height="360"
                src="https://mega.nz/embed/TUAzSIJB#Fsru5i0KYkcPGD5x4Jey0-QdE-ERFcB8NQbIUoN04RQ"
                title="Vídeo 1 - Encontro de Casais"
                frameBorder="0"
                allowFullScreen
              />
            ...
            <div className="video-card">
              <iframe
                ...
                title="Vídeo 2 - Momento de Oração e Louvor"
                frameBorder="0"
                allowFullScreen
              />
            ...
            <div className="video-card">
              <iframe
                ...
                title="Vídeo 3 - Confraternização dos Casais"
                frameBorder="0"
                allowFullScreen
              />
        ...
        <div className="d-flex flex-wrap justify-content-center gap-4 p-3">
          {[c2, c2].map((img, idx) => (
            <div key={idx} className="cardd">
              <img src={img} alt="Casal Líder" />
              <h2 className="card-title">CASAL — LÍDER</h2>
              <h3 className="card-title">Pastores</h3>
              <h4 className="card-title">{idx === 0 ? "Marcos & Solange" : "Pina & Carla"}</h4>
              <Social>
      ...
      <div className="card mt-4 bg-success bg-opacity-75">
        ...
        <div className="d-flex flex-wrap justify-content-center gap-4 p-3">
          {[c2, c2, c1].map((img, idx) => {
            const nomes = ["Altair & Hellen", "Paulo & Vaildes", "Ueslei & Jessica"];
            const cargos = ["LÍDER", "VICE-LÍDER", "SECRETÁRIO"];
            return (
              <div key={idx} className="cardd">
                <img src={img} alt={`Casal ${cargos[idx]}`} />
                <h2 className="card-title">CASAL</h2>
                <h3 className="card-title">{cargos[idx]}</h3>
                <h4 className="card-title">{nomes[idx]}</h4>
                <Social>
                  <a href={linkZap} target="_blank" rel="noreferrer">
                    <FaWhatsapp />
                  </a>
